...
while: migrating our entire app from Flutter to KMP.
...
grown to ~1200 lines, the codebase had ~40K lines spread across ~500 files. *None of it written by hand.*

And the result? I'll let you decide. One of the videos below is the original & the other is the migration done by
claude.
